...
reservas = [
 ...
 {"q": "✅ RESUELTO — festival Charlie Parker: sáb 29, Marcus Garvey Park, 14:00 a 19:00, cierra JOSHUA REDMAN con Nat Adderley Jr., Catherine Russell y Nicole Glover", "cuando": "verificado el 27/8", "url": "cityparksfoundation.org",
 ...
 {"q": "✅ RESUELTO — la rotonda del Guggenheim está CERRADA hasta el 17/9. Por eso el domingo entra MoMA PS1 en su lugar; el Guggenheim quedó como alternativa escrita en el bloque de las 18:20", "cuando": "verificado el 27/8, ya no hay que llamar", "url": "guggenheim.org",
 ...
 {"q": "STUDIO MUSEUM sáb 29 — entrada con HORARIO ASIGNADO, sacarla antes. «Fade» cierra el 6/9: el sábado es la única pasada del viaje", "cuando": "HOY", "url": "studiomuseum.org",
  "por": "Reabrió este año tras siete cerrado, en el edificio nuevo de Adjaye. Sugerido $16, gratis los domingos. Lo detectó el barrido del 27/8: la entrada es con hora asignada, no se entra y ya.", "urg": 3},
 {"q": "FRICK mié 2 — reservar la ventana a voluntad de 13:30 a 17:30", "cuando": "HOY", "url": "frick.org",
  "por": "Esa ventana es TODA: fuera de ella son $30 por cabeza. Online el mínimo es $5. El cupo en puerta existe pero no está garantizado, y son solo cuatro horas.", "urg": 3},
 {"q": "MORGAN LIBRARY vie 4 — las reservas del viernes gratis (17-20h) se liberan HOY, viernes 28", "cuando": "HOY, es el día", "url": "themorgan.org",
  "por": "Reserva obligatoria y se agota. Si no sale, el viernes queda un hueco de 17:00 a 18:10 antes del SUMMIT.", "urg": 3},
 ...
 {"q": "AirTrain + NJ Transit — ahora es el PLAN B de la llegada (entró el Uber Shuttle). Igual conviene reverificarlo: es lo que salva el sábado si migraciones se estira", "cuando": "HOY, viernes 28", "url": "njtransit.com",
