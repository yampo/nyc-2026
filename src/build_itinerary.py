...
day(1, "2026-08-29", "Sábado", "both", "Ink48",
    ...
    [
     ...
     b("16:30", "★★ CHARLIE PARKER JAZZ FESTIVAL — VERIFICADO el 27/8: la música va de 14:00 a 19:00 en Marcus Garvey Park, y el cartel es JOSHUA REDMAN de cierre, con Nat Adderley Jr., Catherine Russell, Nicole Glover y DJ Kultured Child. Ustedes entran 16:30 con la franja 16:30-18:30: la reserva de Hudson VU no es modificable y manda. ⚠️ SALIDA OBLIGADA 18:30 — Redman cierra, así que van a ver el arranque de su set y se pierden el final. Si quieren verlo entero hay que recortar Arthur Avenue y llegar al parque a las 15:30.", "charlieparker29", "both", "destacado"),
...
day(4, "2026-09-01", "Martes", "jp", "JGStay SoHo",
    ...
    [
     ...
     b("10:00", "★★ THE METROPOLITAN MUSEUM OF ART — es inagotable, así que elegí DOS alas y hacelas bien: egipcio + pintura europea, o armas y armaduras + arte islámico. $30 (el pay-what-you-wish es solo para residentes de NY y estudiantes de NY/NJ/CT). QUÉ HAY AHORA (verificado 27/8): «Musical Bodies» en la Galería 199 —130 objetos sobre instrumentos y cuerpo, la primera muestra grande del Met sobre el tema— y «Costume Art» en las galerías de moda nuevas. ⚠️ El CANTOR ROOF GARDEN, la terraza con vista a Central Park que recomiendan todas las guías, está CERRADO desde 2025 y reabre en 2030: no existe en este viaje.", "met", "jp", "destacado"),
...
day(7, "2026-09-04", "Viernes", "both", "The Beacon",
    ...
    [
     ...
     b("14:30", "Almuerzo en Chelsea Market — COMER FUERTE: es la comida grande del día, la cena de hoy es un bocado rápido entre el SUMMIT y el Vanguard. Los Tacos No.1 o Very Fresh Noodles. Ahora hay casi DOS HORAS: sin apuro, y si quedaron galerías de Chelsea sin ver, se vuelve. ★ HEATONIST está ADENTRO de este mismo mercado (12-18:45): más de 100 salsas picantes para probar, con el lineup de Hot Ones. Si el sábado no llegan a la de Williamsburg, esta es la misma cata en menos metros.", "chelseamarket", "both", "comida"),
...
day(8, "2026-09-05", "Sábado", "both", "The Beacon",
    ...
    [
     ...
     b("15:15", "Paseo por Williamsburg: Bedford Ave, disquerías y vintage. ★ ACÁ ENTRA HEATONIST (121 Wythe Ave, a una cuadra de Bedford): la tienda insignia de salsas picantes, con más de 100 para probar en el local y el lineup completo de Hot Ones. Abre 12-19 todos los días, así que a esta hora está abierta y les queda de camino al Williamsburg Bridge. OPCIONAL si quieren la panorámica: Westlight (piso 22, sin cover, un trago) — lo bajaron a 'quizás'. NO comer nada: lo que viene lo merece.", "heatonistwb", "both", "paseo"),
